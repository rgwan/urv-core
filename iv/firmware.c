...
#define UART_ODR (*(volatile char*)0x10010000)
#define UART_IDR (*(volatile char*)0x10010004)
#define UART_BSRR (*(volatile unsigned int*)0x10010008)
#define UART_SR (*(volatile int*)0x1001000C)
#define TEST (*(volatile int*)   0x00000C00)
...
void print_version()
{
	puts("\r\nKamikaze-uRV (RV32IMC ISA) running on AL3\r\n");
	puts("--- Jan.2017 Serial port demo v2\r\n");
